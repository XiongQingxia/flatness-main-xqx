...
from flatness_control_data_model_optimization.Ui_flatness_control_data_model_optimization_main import Ui_banxingkongzhishumo  #绝对路径
# from .Ui_flatness_control_data_model_optimization_main import Ui_banxingkongzhishumo  # 相对路径
